...
- **Открывается позже:** глазной имплант; сведения о других имплантах.
...
### Пустая комната — будущее расширение текущего крыла
...
- **Риск:** пока не определён.
- **Соединена с:** расположение и соединения будут определены после проверки
  текущей схемы.

### Тихая зона сада — будущее расширение

- **Статус:** секретная опциональная зона будущего расширения.
...
2. Игрок получает цель украсть глазной имплант и самодельную отвёртку.
...
8. В защищённом коридоре игрок видит двери лаборатории и инженерной зоны.
   Пропуск открывает инженерную зону, где игрок крадёт глазной имплант.
9. Игрок возвращается в камеру тем же маршрутом.
10. После установки импланта знакомые зоны показывают камеры и их зоны
    сканирования.
11. После будущего расширения игрок замечает камеру, направленную на пустую
    комнату.
...
| Тайный лаз сада | Будущее расширение | Любовные записки и наблюдение | Спальня поваров | Опциональная улика и связь с другим крылом |
