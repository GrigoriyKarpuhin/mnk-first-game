...
6. Рискованная ранняя альтернатива существует до эксперимента: во время слежки
   за заключённой 2 игрок может проскользнуть за ней через санитарную комнату
   персонала. Если окно упущено, квест программиста не блокируется.
7. Из служебного коридора игрок открывает дверь кухни с обратной стороны. После
   этого она становится постоянным двусторонним shortcut текущего run.
...
До открытия со стороны служебного коридора дверь не поддаётся из кухни. После
первого открытия она становится обычным двусторонним shortcut между кухней и
служебным кольцом. Для этого не требуется новый предмет или идентификатор.
...
|---|---|---|---|---|
| Программист: передатчик | Служебное кольцо, склад, инженерка | Предэкспериментальный шлюз после первого эксперимента | Ранний вход вслед за заключённой 2 | Пропущенная слежка не закрывает путь; дверь кухни открывается с обратной стороны |
| Программист: источник данных, архив, релейная | Собственное технологическое крыло за служебным кольцом | Последовательные этапы квеста и уже открытый служебный shortcut | Глазной имплант раскрывает короткие пути и подсказки | Эти комнаты не требуют входа в сад и не используют награду route заключённой 2 |
| Заключённая 2 | Слежка, комната персонала, сад | Повторяемое утреннее окно через санитарную комнату персонала | Близкое следование даёт ранний вход в служебное кольцо | При провале окно повторяется следующим утром; сад не нужен для первого подслушивания |
...
Сад остаётся наградой route заключённой 2 и альтернативного исследования.
...
- короткое окно прохода вслед за заключённой 2 через санитарную комнату
...
- **санитарная комната персонала:** заметная закрытая дверь; во время утреннего
  маршрута заключённой 2 она кратко даёт рискованный вход в служебное кольцо;
...
5. Первое возвращение из эксперимента гарантированно выводит игрока к обратной
   стороне служебного кольца; ранняя слежка за заключённой 2 даёт рискованный
   способ попасть туда раньше.
6. Из служебного коридора игрок открывает кухонную дверь с обратной стороны и
   превращает карман в shortcut.
