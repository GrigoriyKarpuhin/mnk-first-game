...
public sealed class ProgrammerNPC : NPC
{
    ...
    private static void BeginDataSourceQuest()
    {
        ...
        DialogueUI.Instance.ShowDialogue(
            "Программист",
            "Ищи технологическое крыло за защищённым коридором. Дверь там закрыта отдельным ключом — такие обычно держат в инженерной зоне рядом с оборудованием. Внутри будет панель данных и охрана.\n\n<color=#75D99A>Новая цель: найти ключ технологического крыла и добыть источник данных.</color>",
            "npc_programmer");
    }
